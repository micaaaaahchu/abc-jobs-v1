	    	...
	    	<% int i = 1; %>
		   	<c:forEach var="user" items="${users}">
		        ...
		        <td>
		          ...
		          <a href="delete/${user.getUserId()}" class="" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
				  ...
				  <div class="modal-dialog">
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				        Are you sure you really wish to delete this user?
				      </div>
