...
INSERT INTO `city` VALUES (1,'Jakarta',1),(2,'Kuala Lumpur',2),(3,'Singapore',3),(4,'Manila',4),(5,'Tokyo',5),(6,'China',6),(7,'Sydney',7),(8,'Seoul',8),(9,'Taipei',9),(10,'Bangkok',10);
...
INSERT INTO `conversations` VALUES (1,NULL,'hhwwee','2023-03-27'),(2,1,'hhjjii','2023-03-27');
...
INSERT INTO `countries` VALUES (1,'Indonesia'),(2,'Malaysia'),(3,'Singapore'),(4,'Philippines'),(5,'Japan'),(6,'China'),(7,'Australia'),(8,'South Korea'),(9,'Taiwan'),(10,'Thailand');
...
INSERT INTO `messages` VALUES (1,1,NULL,1,'Hey you still there?','2023-01-29 00:00:00'),(2,1,1,1,'yes, y?','2022-12-27 00:00:00'),(3,1,NULL,1,'owh nvm','2022-12-27 00:00:00'),(4,2,1,1,'p','2022-12-27 00:00:00'),(5,2,NULL,1,'?','2022-12-27 00:00:00'),(6,2,1,1,':p','2022-12-27 00:00:00');
...
INSERT INTO `threads` VALUES (3,2,NULL,'Programming using IntelliJ Idea',NULL,'2023-02-26 00:00:00'),(4,1,1,'Other persistent mental disorders due to conditions classified elsewhere',NULL,'2022-03-20 00:00:00'),(6,4,1,'Tuberculous oophoritis and salpingitis, tubercle bacilli not found (in sputum) by microscopy, but found by bacterial culture',6,'2022-05-26 00:00:00'),(10,2,1,'Chemical burn of eyelids and periocular area',5,'2021-11-04 00:00:00');
...
INSERT INTO `users` VALUES (1,1,'admin@myadmin.net','admin','2022-04-18','2022-04-18');
